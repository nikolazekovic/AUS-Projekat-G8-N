...
namespace Modbus.ModbusFunctions
{
    ...
    public class WriteSingleCoilFunction : ModbusFunction
    {
        ...
        public override Dictionary<Tuple<PointType, ushort>, ushort> ParseResponse(byte[] response)
        {
            ...
            ushort coilValue = (ushort)IPAddress.NetworkToHostOrder((short)BitConverter.ToUInt16(response, 10));
            ushort normalizedValue = coilValue == 0 ? (ushort)0 : (ushort)1;

            return new Dictionary<Tuple<PointType, ushort>, ushort>
            {
                { new Tuple<PointType, ushort>(PointType.DIGITAL_OUTPUT, address), normalizedValue }
            };
        }
    }
}
